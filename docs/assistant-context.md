...
- Admin `/user <order_id|email|web_username>` renders website order support cards through `src/vpnbot/web_order_profile.py`, including linked Telegram IDs/devices, Marzban status, and next commands for support.
